      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-12">
          <div class="imageTitle">
            <img
              src="https://d33wubrfki0l68.cloudfront.net/80d7ad23ab1030d61b7aa6bcd74cb385f758044b/29982/imgs/fcwcc.png"
            />
            <h3>كأس العالم للاندية</h3>
          </div>
        </div>
        <div class="col-lg-8 col-12">
          <div class="info">
            ...
            <p>
              كأس العالم للاندية , بطولة تقام موسمياً في فترة منتصف الموسم ,
              تقام بنظام خروج المغلوب بين الاندية الـ8 أبطال القارات , بطل دوري
              أبطال أوروبا و بطل الدوري الاوروبي و بطل كلاً من إفريقيا و أسيا و
              الكوبا ليبيرتادوريس و أستراليا و أمريكا الشمالية.
            </p>
            <hr />
...
.FCWC {
  ...
  .imageTitle {
    ...
    border-radius: 10px;
    overflow: hidden;
    box-shadow: 0 0 7px rgba($color: $fcwc, $alpha: 0.15);
    margin-bottom: 25px;
    img {
      width: 220px;
      height: 220px;
  ...
  .am {
    h5 {
      width: 80%;
      margin: 10px auto;
      box-shadow: 0 0 2px rgba($color: $fcwc, $alpha: 0.2);
      text-align: right;
      @include em {
        width: 85%;
      }
  ...
  .sbest {
    ...
    h5 {
      ...
      font-family: "Changa", sans-serif;
      font-weight: bold;
      box-shadow: 0 0 5px rgba($color: $fcwc, $alpha: 0.15);
      &:nth-of-type(4),
      &:nth-of-type(5),
      &:nth-of-type(6) {
        background: green;
...
export default {
  ...
  methods: {
    selectSeason() {
      ...
      // Get Season State
      db.get(`Seasons/${seNum}/FCWC`).then(respon => {
      ...
      db.get(`Seasons/${seNum}`).then(res => {
        // GET SEASONS MATCHES
        db.getting(
          `Seasons/${seNum}/FCWC/matches`,
          response => {
            $(".AllMatches .round").remove();
            var numer = 1;
            response.data.forEach(round => {
              ...
              arrRounds.forEach(match => {
                if (typeof match == "object") {
                  ...
                  $(".AllMatches .round:last-of-type").append(Match);
                }
              });
              numer++;
            });
        ...
        // GET SEASONS BEST
        db.getting(`Seasons/${seNum}/FCWC/BEST`, res => {
          res.data.forEach(player => {
        ...
        db.get(`Seasons/${seNum}/FCWC/matches`, { sort: ["-num"] }).then(
          response => {
        ...
        if (res.value) {
          Swal.fire({
            ...
            html: `
                  ...
                  <label>الفريق السادس</label>
                  <input id="Team6" class="swal2-input" type="text" style="display:block">
                  <label>الفريق السابع</label>
                  <input id="Team7" class="swal2-input" type="text" style="display:block"> 
                  <label>الفريق الثامن</label>
                  <input id="Team8" class="swal2-input" type="text" style="display:block">
                  `,
            showCancelButton: true,
            focusConfirm: false,
            preConfirm: () => {
            ...
            if (val.value) {
              ...
              var team6 = val.value[5];
              var team7 = val.value[6];
              var team8 = val.value[7];
              ...
              if (Clubs.includes("ليستر سيتي")) {
                db.get(`playersData/hassan/toursStats/fcwc`).then(pd => {
                  var part = pd.data[0] + 1;
                  db.update(`playersData/hassan/toursStats/fcwc`, {
                    part
                  });
                });
              }
              ...
              if (Clubs.includes("مانشيستر سيتي")) {
                db.get(`playersData/mo/toursStats/fcwc`).then(pd => {
                  var part = pd.data[0] + 1;
                  db.update(`playersData/mo/toursStats/fcwc`, {
                    part
                  });
                });
              }
              ...
              db.get("Seasons", {
                ...
                db.update(`Seasons/${SeNum}/FCWC`, {
                  state: false
                });

                // 1ST ROUND
                db.update(`Seasons/${SeNum}/FCWC/matches/round1`, {
                  num: 1
                });

                // 3RD ROUND MATCHES
                db.update(`Seasons/${SeNum}/FCWC/matches/round1/match1`, {
                  home: Clubs[0],
                  homeScore: 0,
                  away: Clubs[1],
                  awayScore: 0,
                ...
                db.update(`Seasons/${SeNum}/FCWC/matches/round1/match2`, {
                  home: Clubs[2],
                  homeScore: 0,
                  away: Clubs[3],
                  awayScore: 0,
                ...
                db.update(`Seasons/${SeNum}/FCWC/matches/round1/match3`, {
                  home: Clubs[4],
                  homeScore: 0,
                  away: Clubs[5],
                  awayScore: 0,
                ...
                db.update(`Seasons/${SeNum}/FCWC/matches/round1/match4`, {
                  home: Clubs[6],
                  homeScore: 0,
                  away: Clubs[7],
                  awayScore: 0,
                ...
                // 4TH ROUND
                db.update(`Seasons/${SeNum}/FCWC/matches/round2`, {
                  num: 2
                });

                // 4TH ROUND MATCHES
                db.update(`Seasons/${SeNum}/FCWC/matches/round2/match1`, {
                  home: "لم يتأهل بعد",
                  homeScore: 0,
                  away: "لم يتأهل بعد",
                  awayScore: 0,
                ...
                db.update(`Seasons/${SeNum}/FCWC/matches/round2/match2`, {
                  home: "لم يتأهل بعد",
                  homeScore: 0,
                  away: "لم يتأهل بعد",
                  awayScore: 0,
                ...
                // 5TH ROUND
                db.update(`Seasons/${SeNum}/FCWC/matches/round3`, {
                  num: 3
                });

                // 5TH ROUND MATCHES
                db.update(`Seasons/${SeNum}/FCWC/matches/round3/match1`, {
                  home: "لم يتأهل بعد",
                  homeScore: 0,
                  away: "لم يتأهل بعد",
                  awayScore: 0,
                ...
                // ADD GOAL SCORERS
                db.add(`Seasons/${SeNum}/FCWC/GS/1`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 1
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/2`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 2
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/3`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 3
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/4`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 4
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/5`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 5
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/6`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 6
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/7`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 7
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/8`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 8
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/9`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 9
                });

                db.add(`Seasons/${SeNum}/FCWC/GS/10`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 10
                });
                ...
                // ADD ASSIST MAKERS
                db.add(`Seasons/${SeNum}/FCWC/AS/1`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 1
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/2`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 2
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/3`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 3
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/4`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 4
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/5`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 5
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/6`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 6
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/7`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 7
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/8`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 8
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/9`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 9
                });

                db.add(`Seasons/${SeNum}/FCWC/AS/10`, {
                  player: "لم يتم التعيين",
                  goals: 0,
                  _id: 10
                });
                ...
                // ADD SEASONS BEST
                db.add(`Seasons/${SeNum}/FCWC/BEST/FORWOARD`, {
                  player: "لم يتم التعيين",
                  _id: "FORWOARD"
                });

                db.add(`Seasons/${SeNum}/FCWC/BEST/CENTER`, {
                  player: "لم يتم التعيين",
                  _id: "CENTER"
                });

                db.add(`Seasons/${SeNum}/FCWC/BEST/DEFENDER`, {
                  player: "لم يتم التعيين",
                  _id: "DEFENDER"
                });

                db.add(`Seasons/${SeNum}/FCWC/BEST/GOALKEEPER`, {
                  player: "لم يتم التعيين",
                  _id: "GOALKEEPER"
                });

                var checker = setInterval(() => {
                  db.get(`Seasons/${SeNum}/FCWC`).then(res => {
                    if (res.data.length >= 5) {
                      clearInterval(checker);
                      Swal.fire(
                        "Done!",
                        "FCWC Add Successfully To Season " + SeNum,
                        "success"
                      ).then(() => {
                        setTimeout(() => {
                          location.reload();
    ...
    EndThisSeason() {
      Swal.fire({
        ...
        if (res.value) {
          var seNum = $(".select select").val();
          db.get(`Seasons/${seNum}/FCWC/matches`).then(res => {
            var checker = 0;
            ...
            if (checker > 0) {
              ...
              db.get(`Seasons/${seNum}/FCWC/matches/round3/match1`).then(
                res => {
                  ...
                  if (winner == "ليستر سيتي") {
                    firebase
                      .database()
                      .ref(`playersData/hassan/toursStats/fcwc`)
                      .transaction(data => {
                        data.win++;
                        return data;
                      })
                    ...
                    firebase
                      .database()
                      .ref(`playersData/mo/toursStats/fcwc`)
                      .transaction(data => {
                        data.win++;
                        return data;
                      })
  ...
  created() {
    window.scrollTo(0, 0);
    document.title = "ROPT | FIFA CLUB WORLD CUP";
    $(".preloader").show();
  ...
  mounted() {
    // SET MATCH RESULT
    $(".AllMatches").on("click", ".match i", function() {
      var id = $(this)
        .parent()
        .attr("id");
      var seNum = $(".select select").val();
      ...
      Swal.fire({
        ...
        if (val.value) {
          ...
          db.update(`Seasons/${seNum}/FCWC/matches/${id}`, {
            homeScore,
            awayScore,
            state: true
          }).then(() => {
            ...
            // ROUND OF 2
            else if (id == "round5/match1") {
              if (homeScore > awayScore) {
                // db.update(`Seasons/${seNum}/FCWC/matches/round5/match1`, {
                //   home
                // }).then(location.reload());
              } else {
                // db.update(`Seasons/${seNum}/FCWC/matches/round5/match1`, {
    ...
    $(".gs h5").on("dblclick", function() {
      ...
      Swal.fire({
        ...
        if (val.value) {
          ...
          db.update(`Seasons/${seNum}/FCWC/GS/${id}`, {
            player,
            goals
          });
        }
    ...
    $(".am h5").on("dblclick", function() {
      ...
      Swal.fire({
        ...
        if (val.value) {
          var player = val.value[0];
          var goals = val.value[1];
          db.update(`Seasons/${seNum}/FCWC/AS/${id}`, {
            player,
            goals
          });
        }
    ...
    $(".sbest p").on("dblclick", function() {
      ...
      Swal.fire({
        ...
        if (val.value) {
          var player = val.value[0];
          db.update(`Seasons/${seNum}/FCWC/BEST/${id}`, {
            player
          });
        }
      });
